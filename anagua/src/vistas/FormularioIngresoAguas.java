...
public class FormularioIngresoAguas {
	...
	private void initialize() {
		...
		order.add(DQO3);
		order.add(DQO4);
		order.add(AceitesYGrasas1);
		order.add(AceitesYGrasas2);
		order.add(AceitesYGrasas3);
		order.add(AceitesYGrasas4);
		...
		order.add(nitrato3);
		order.add(nitrato4);
		order.add(nitrogenoTotal1);
		order.add(nitrogenoTotal2);
		order.add(nitrogenoTotal3);
		order.add(nitrogenoTotal4);
		order.add(fosforoTotal1);
		order.add(fosforoTotal2);
		order.add(fosforoTotal3);
		order.add(fosforoTotal4);
		order.add(cromo1);
		order.add(cromo2);
		order.add(cromo3);
		order.add(cromo4);
		...
		order.add(aluminio3);
		order.add(aluminio4);
		order.add(manganeso1);
		order.add(manganeso2);
		order.add(manganeso3);
		order.add(manganeso4);
		order.add(potasio1);
		order.add(potasio2);
		order.add(potasio3);
		order.add(potasio4);
		order.add(alcalinidadTotal1);
		order.add(alcalinidadTotal2);
		order.add(alcalinidadTotal3);
		order.add(alcalinidadTotal4);
		order.add(acidezVolatil1);
		order.add(acidezVolatil2);
		order.add(acidezVolatil3);
		order.add(acidezVolatil4);
		order.add(alfa1);
		order.add(alfa2);
		order.add(alfa3);
		order.add(alfa4);
		order.add(alfaPrima1);
		order.add(alfaPrima2);
		order.add(alfaPrima3);
		order.add(alfaPrima4);
		order.add(bicarbonato1);
		order.add(bicarbonato2);
		order.add(bicarbonato3);
		order.add(bicarbonato4);
		order.add(salinidad1);
		order.add(salinidad2);
		order.add(salinidad3);
		order.add(salinidad4);
		order.add(turbiedad1);
		order.add(turbiedad2);
		order.add(turbiedad3);
		order.add(turbiedad4);
		...
		order.add(fenoles3);
		order.add(fenoles4);
		order.add(tensoactivos1);
		order.add(tensoactivos2);
		order.add(tensoactivos3);
		order.add(tensoactivos4);
		order.add(cloroResidual1);
		order.add(cloroResidual2);
		order.add(cloroResidual3);
		order.add(cloroResidual4);
		order.add(cloroTotal1);
		order.add(cloroTotal2);
		order.add(cloroTotal3);
		order.add(cloroTotal4);
		order.add(cloruro1);
		order.add(cloruro2);
		order.add(cloruro3);
		order.add(cloruro4);
		...
		order.add(color3);
		order.add(color4);
		order.add(hidrocarburos1);
		order.add(hidrocarburos2);
		order.add(hidrocarburos3);
		order.add(hidrocarburos4);
		order.add(coliformes1);
		order.add(coliformes2);
		order.add(coliformes3);
		order.add(coliformes4);
		order.add(cursoAguaTipo1);
		order.add(cursoAguaTipo2);
		order.add(cursoAguaTipo3);
		order.add(cursoAguaTipo4);
		order.add(otros11);
		order.add(otros12);
		order.add(otros13);
		order.add(otros14);
