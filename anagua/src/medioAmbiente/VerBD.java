...
public class VerBD {
    ...
    public static void verBD() {
        try {
            ...
            cell.setCellValue("Otros 1");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            cell = row.createCell(74);
            cell.setCellValue("Otros 2");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            cell = row.createCell(75);
            cell.setCellValue("Otros 3");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            cell = row.createCell(76);
            cell.setCellValue("Otros 4");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            ...
            cell.setCellStyle(setStyleParaTitulos(workbook, true));
            cell = row.createCell(26);
            cell.setCellValue("mgN/L");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            cell = row.createCell(27);
            cell.setCellValue("mgS/L");
            cell.setCellStyle(setStyleParaTitulos(workbook, true));
            cell = row.createCell(28);
            cell.setCellValue("mg/L");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            ...
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            cell = row.createCell(33);
            cell.setCellValue("mgP/L");
            cell.setCellStyle(setStyleParaTitulos(workbook, true));
            cell = row.createCell(34);
            cell.setCellValue("m3/H");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            cell = row.createCell(35);
            cell.setCellValue("mgCaCO3/L");
            cell.setCellStyle(setStyleParaTitulos(workbook, true));
            cell = row.createCell(36);
            cell.setCellValue("mg/L");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            ...
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            cell = row.createCell(39);
            cell.setCellValue("mS/cm");
            cell.setCellStyle(setStyleParaTitulos(workbook, true));
            cell = row.createCell(40);
            cell.setCellValue("PSU");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            cell = row.createCell(41);
            cell.setCellValue("NTU");
            cell.setCellStyle(setStyleParaTitulos(workbook, true));
            cell = row.createCell(42);
            cell.setCellValue("mg/L");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            ...
            cell.setCellStyle(setStyleParaTitulos(workbook, true));
            cell = row.createCell(44);
            cell.setCellValue("mg/L MBAS-LAS (342 g/mol)");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            cell = row.createCell(45);
            cell.setCellValue("mgCl2/L");
            cell.setCellStyle(setStyleParaTitulos(workbook, true));
            cell = row.createCell(46);
            cell.setCellValue("ufc/100mL");
            cell.setCellStyle(setStyleParaTitulos(workbook, false));
            cell = row.createCell(47);
            cell.setCellValue("");
            cell.setCellStyle(setStyleParaTitulos(workbook, true));
            ...
            while (resultSet.next()) {
                ...
                */
                ...
                cell.setCellStyle(cellStyle);
                cell = row.createCell(74);
                cell.setCellValue(resultSet.getString("otros2"));
                cell.setCellStyle(cellStyle);
                cell = row.createCell(75);
                cell.setCellValue(resultSet.getString("otros3"));
                cell.setCellStyle(cellStyle);
                cell = row.createCell(76);
                cell.setCellValue(resultSet.getString("otros4"));
                cell.setCellStyle(cellStyle);
                i++;
            }
